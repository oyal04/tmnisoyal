...
<div class="container pt-0 shadow p-0 mb-0 bg-dark">   
        ...
        <div class="row ms-2">
                ...
                <div class="col-sm-4">
                    <div class="row">
                            <div class="alert alert-warning">
                                <b> Menu</b>: Simpanan Sukarela Atas Nama <?php echo "$namal" ; ?>      
                            </div>                          
                    </div>
                    <div class="row">
            ...
            <div class="col-sm-8">
                    ...
                    <div class="col">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered style='width:100%'">
                                    ...
                                    <?php
                                        $no = 1;
                                        $data = mysqli_query($konektor,"select * from msimsukrel");
                                        while($d = mysqli_fetch_array($data)){
                                        ?> 
                                    <tbody id="tabelbody">
                                    <tr>
                                        <td><?php echo $no++;?></td>
                                        <td><?php echo $d['TanggalSimpanan'];?></td>
                                        <td><?php echo $d['JumlahSimpanan'];?></td>
                                        <td><?php echo $d['TotalSimpanan'];?></td>
                ...
                <div class="row">
                    <div class="col">
                      <h2>Total Tagihan = Rp.<?php echo "$simsukrel"?></h2>
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col">
                     <p>Terbilang = Delapan Ratus Ribu Rupiah</p>
                    </div>
                </div>
